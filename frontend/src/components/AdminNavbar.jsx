  ...
  return (
    <nav className="bg-blue-600 text-white p-4 flex justify-between items-center w-full">
      ...
      <div className="flex space-x-4">
        <Link to="/admin/pending-approvals" className="px-6 py-3 bg-blue-500 rounded-lg hover:bg-blue-700 transition font-semibold text-white shadow-md whitespace-nowrap">
          Pending Approvals
        </Link>
