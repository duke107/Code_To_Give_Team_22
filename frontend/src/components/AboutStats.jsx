...
const AboutStats = () => {
  return (
    <div>
      <h2 className="text-3xl font-bold text-red-600 text-center mb-4">IMPACT IN NUMBERS</h2>
    <div className="grid grid-cols-2 md:grid-cols-4 gap-6 text-center py-12">
      {stats.map((stat, i) => (
        <div key={i} className="p-6 bg-red-100 rounded shadow-md">
