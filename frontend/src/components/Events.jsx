      ...
      {isLoading ? (
        ...
        <>
          {events.length === 0 ? (
            ...
            {/* Toggle Button for Not Approved Events */}
  ...
  >
    ...
    >
      <path
        ...
        strokeLinejoin="round"
        strokeWidth={2}
        d={showNotApproved ? "M5 15l7-7 7 7" : "M19 9l-7 7-7-7"}
      />
    </svg>
  </button>
</div>

{/* Render Not Approved Events Only When ShowNotApproved is True */}
{showNotApproved && notApprovedEvents.length > 0 && (
  <div className="mt-8">
    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
      {notApprovedEvents.map((event) => (
        <motion.div
          key={event._id}
          className="bg-gray-200 rounded-xl shadow-lg overflow-hidden border border-gray-200 hover:shadow-2xl transition-all duration-300 group flex flex-col"
          whileHover={{ scale: 1.02 }}
          whileTap={{ scale: 0.98 }}
        >
          <div className="h-48 overflow-hidden">
