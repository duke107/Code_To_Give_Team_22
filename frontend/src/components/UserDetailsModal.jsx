  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50">
      <div className="bg-white p-6 rounded-lg shadow-lg w-[500px] max-h-[80vh] overflow-y-auto">
        ...
        {/* Event Organiser Specific Details */}
        {user.role === "Event Organiser" && (
          <>
            ...
            <div className="mt-4 flex gap-4">
              <button className="bg-yellow-500 text-white px-4 py-2 rounded" onClick={() => setShowWarnForm(true)}>
                Warn
              </button>
              <button className="bg-red-500 text-white px-4 py-2 rounded" onClick={handleRemoveOrganizer}>
                Remove
              </button>
            </div>
            ...
            {showWarnForm && (
              <div className="mt-4 border p-4 rounded bg-gray-100">
                ...
                <div className="mt-2 flex justify-between">
                  <button className="bg-blue-500 text-white px-4 py-2 rounded" onClick={handleWarnSubmit}>
                    Send Warning
                  </button>
                  <button className="bg-gray-500 text-white px-4 py-2 rounded" onClick={() => setShowWarnForm(false)}>
                    Close
                  </button>
                </div>
              </div>
