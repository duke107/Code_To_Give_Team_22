...
import { Alert, Button, FileInput, TextInput, Card, Label, Spinner, ButtonGroup } from "flowbite-react"
      ...
      <div className="container mx-auto p-6">
        <Card className="max-w-4xl mx-auto shadow-lg">
          <div className="flex justify-center mb-4">
            <h1 className="text-3xl font-bold text-center text-blue-700">Create an Event</h1>
          </div>
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div>
              <label className="block mb-2 font-medium text-lg">Start Date</label>
              <DatePicker
            ...
            <Card className="overflow-hidden">
              <div className="p-4">
                <div className="mb-2 block">
                  <Label htmlFor="file" value="Upload Image" className="text-lg font-medium" />
                </div>
              ...
              {formData.image && (
                <img src={formData.image || "/placeholder.svg"} alt="Uploaded" className="w-full h-72 object-cover" />
              )}
            </Card>
            ...
            <div className="relative">
              <div className="mb-2 block">
                <Label htmlFor="content" value="Content" className="text-lg font-medium" />
              </div>
